import {templateValues} from "./emailVerification";


const emailOTPTemplate = function (otp: string, username: string): templateValues {
    const html = `
    <!DOCTYPE html>
    ...
    <body
      ...
      <div style="display: none;">A request to sign in to your account on MallaTY E-Commerce, use the one-time-password below to login
      </div>
      <div role="article" aria-roledescription="email" aria-label="Login one-time-password" lang="en">
                      ...
                      <tr>
                        <td class="sm-px-24"
                          ...
                          <p style="margin: 0 0 24px;">
                           <br>A request to sign in to your account on MallaTY E-Commerce, use the one-time-password below to login
                          </p>
                          <lable style="display: block; font-size: 24px; line-height: 100%; margin-bottom: 24px; --text-opacity: 1; color: #000000; text-decoration: none;"><h2>${otp}</h2></lable>
                        ...
                        <p style="margin: 0 0 16px;">Thanks, <br>MallamTY ECommerce Support Team</p>
